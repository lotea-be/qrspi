...
| Skill (workflow) | `.claude/skills/workflow/SKILL.md` | `.github/instructions/workflow.instructions.md` |
...
the **AskUserQuestion** tool) whether to apply, defer, or skip. Apply the approved edits
