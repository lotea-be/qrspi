...
the #tool:vscode/askQuestions to ask: "Have you reviewed and approved design.md for
...
Otherwise continue as the architect to produce:
...
to the human one at a time (vscode/askQuestions: *Add as idea / Skip*) and add
...
`backlog.md` are written, use the #tool:vscode/askQuestions to ask:
