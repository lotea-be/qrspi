...
here in the orchestrator (vscode/askQuestions is not available inside a subagent).
...
#tool:vscode/askQuestions, naming the steer-appropriate default in the question
text:
