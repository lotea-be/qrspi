...
| Skill (workflow) | `.github/instructions/workflow.instructions.md` | `.github/instructions/workflow.instructions.md` |
...
- **Prompt/process friction** (a stale fact, a missing convention, a step
  ...
  governing `.github/` files (and the project's contributor-guidance file).
