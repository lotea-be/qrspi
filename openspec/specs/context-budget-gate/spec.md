# context-budget-gate Specification

## Purpose
An in-session counter and self-assessment gate that warns the orchestrator to
reset context before quality degrades across long QRSPI sessions. Created by
archiving change orchestrator-context-budget. Update Purpose after archive.
