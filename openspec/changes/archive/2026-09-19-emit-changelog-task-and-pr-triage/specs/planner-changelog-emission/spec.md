# Spec — planner-changelog-emission

> New capability introduced by the `emit-changelog-task-and-pr-triage` change.
> Planner rule that detects kit-touching changes and appends a standing CHANGELOG
> housekeeping task group to `tasks.md`, including a divergence-check exemption.
