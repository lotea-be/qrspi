...
> New capability introduced by the `add-auto-mode` change. Ternary run-mode
> (Full auto / Semi-auto / Manual) for the QRSPI main-loop orchestrator,
> carried in-process across an auto chain with no disk persistence.
